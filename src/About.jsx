    ...
    <div className="text-center">
      ...
      <div className="text-center">
        <div className="col-md-center">
            <img src="https://us1-photo.nextdoor.com/business_logo/33/3f/333f4fb9565acae147077042d35c12db.jpeg" width="200" className="img-fluid" alt="Tellico Fire Badge"/>
        </div>
      </div>
          <br/>
